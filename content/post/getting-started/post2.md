...
![Local version control](https://git-scm.com/book/en/v2/images/local.png){ #fig:001 width=70% }
...
![Centralized version control](https://git-scm.com/book/en/v2/images/centralized.png){ #fig:002 width=70% }
...
![Distributed version control](https://git-scm.com/book/en/v2/images/distributed.png){ #fig:002 width=70% }
